...
function currentObjective(){
  ...
  const sawRun=stationRuns().saw_t1;if(sawRun)return{sprite:"saw_t1",step:sawRun.status==="running"?countLabel+": Bandsaw is cutting the blank":countLabel+": Bandsaw blank is ready",how:sawRun.status==="running"?"Work elsewhere while the 5-minute saw timer runs, or open the station to check progress.":"Open the green BANDSAW flag and collect the labeled blank."};
