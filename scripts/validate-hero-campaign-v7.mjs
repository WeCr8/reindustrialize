...
for(const token of ['gameplay-hero-v7.mp4','gameplay-hero-v7.vtt','soundToggle','soundBeacon','Click to hear narration','Reindustrialize America','Build your company'])if(!landing.includes(token))fail.push(`landing missing ${token}`);
