...
const required=['order_material','accept_job','cut_raw_stock','select_primary_tool','set_stickout','complete_tool_kit','prove_gcode','run_cnc_cycle','review_quality_result'];
