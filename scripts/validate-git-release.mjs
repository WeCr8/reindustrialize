...
const publishedReleaseMedia = new Set(['apps/playreind-landing/public/media/gameplay-demo-v6.mp4','apps/playreind-landing/public/media/gameplay-hero-v7.mp4','apps/playreind-landing/public/media/gameplay-hero-v8.mp4']);
const forbidden = [
  /^\.env(?!\.example$)(?:\.|$)/,
  /^cloudflare-dist\//,
  /^dist\//,
