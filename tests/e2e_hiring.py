...
with sync_playwright() as p:
 ...
 page.goto(URL);page.wait_for_function("loaded===total");[page.locator("#preFounderNext").click() for _ in range(4)];page.locator("#newGame").click();[page.locator("#introNext").click() for _ in range(5)];page.locator("#tourSkip").wait_for(timeout=10000);page.locator("#tourSkip").click();page.locator("#bteam").click()
