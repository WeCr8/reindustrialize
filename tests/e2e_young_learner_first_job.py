...
with sync_playwright() as p:
    ...
    page.locator("#kidSetCut").click();page.locator("#cutStock").click();page.wait_for_function("state.rawStockReady")
    ...
    page.locator("#objectiveAction").click();page.locator('[data-b="o"]').wait_for(timeout=10000)
    page.locator("#cycst").click();assert page.evaluate("machineMotionMode===null")
    page.locator("#kidLoadCodes").click()
    page.locator("#autonomousRun").click();page.locator("#machineFlag").wait_for()
    assert "RUNNING" in page.locator("#machineFlag").inner_text()
